...
INSERT INTO FUNCIONES (id_pelicula, id_sala, fecha_hora, precio_base) VALUES
    (1, 1, DATEADD(hour, 18, DATEADD(day, 7, CAST(GETDATE() AS DATE))), 4500.00),
    (2, 2, DATEADD(hour, 21, DATEADD(minute, 30, DATEADD(day, 7, CAST(GETDATE() AS DATE)))), 3500.00),
    (3, 3, DATEADD(hour, 15, DATEADD(day, 8, CAST(GETDATE() AS DATE))), 2800.00),
    (4, 4, DATEADD(hour, 20, DATEADD(day, 8, CAST(GETDATE() AS DATE))), 3500.00),
    (5, 5, DATEADD(hour, 19, DATEADD(minute, 15, DATEADD(day, 9, CAST(GETDATE() AS DATE)))), 2500.00),
    (1, 6, DATEADD(hour, 22, DATEADD(day, 9, CAST(GETDATE() AS DATE))), 3500.00);
